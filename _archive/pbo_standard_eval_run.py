...
parser.add_argument(
    ...
    help='data directory')
parser.add_argument(
    '--results_dir', type=str, default='clsStandardRoot/results/',
    help='relative path to results folder, i.e. '+
    'the directory containing models_exp_code relative to project root (default: ./results)')
parser.add_argument(
    '--save_exp_code', type=str, default='',
    help='experiment code to save eval results')
parser.add_argument(
    '--models_exp_code', type=str, default='exp_code_pbo_s7',
    help='experiment code to load trained models (directory under results_dir containing model checkpoints')
parser.add_argument(
    '--splits_dir', type=str, default=None,
...
parser.add_argument(
    '--micro_average', action='store_true', default=False, 
...
eval stats:
    k=1:
        test_error:     0.5961538461538461
        auc:            0.37320574162679426
    k=2:
        i=0:
            test_error:  0.5961538461538461
            auc:  0.37320574162679426
