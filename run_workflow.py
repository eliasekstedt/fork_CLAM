...
if __name__ == '__main__':
    ...
    while True:
        """
        potentially weak signal:
            high: ['091_AB', '039_DEF', '125_DEF', '042_DE', '071_FGH', '167_CD', '200_AB', '162_DEF', '168_DEF', '001_ABC', '205_DEF']
            high: ['091_AB', '039_DEF', '125_DEF', '042_DE', '071_FGH', '167_CD', '200_AB', '001_ABC', '162_DEF', '168_DEF', '205_DEF']
            high: ['091_AB', '039_DEF', '125_DEF', '071_FGH', '042_DE', '167_CD', '200_AB', '162_DEF', '168_DEF', '001_ABC', '205_DEF']

        potentially strong signal:
            low: ['144_EF', '210_L', '201_KL', '010_KL', '148_DEF', '031_ABC', '012_AB', '208_DEF', '110_DEF', '144_CD']
            low: ['144_EF', '210_L', '201_KL', '010_KL', '148_DEF', '031_ABC', '208_DEF', '110_DEF', '012_AB', '144_CD']
            low: ['144_EF', '210_L', '201_KL', '010_KL', '148_DEF', '031_ABC', '012_AB', '144_CD', '110_DEF', '208_DEF']
        """
        ...
        #    '091_AB', '039_DEF', '125_DEF', '042_DE', '071_FGH',
        #    '167_CD', '200_AB', '162_DEF', '168_DEF', '001_ABC', '205_DEF'
        #]
        """
        excl_const excluded by default
        *next remove the potentially strong of the list above from the list below consider weather to include the potentially week or not.
        * MDS3lN: potentially week were excluded + excl_rnd_set excluded | 0.0 rate: 12 / 100
        * ? : potentially week included + excl_rnd_set excluded | 0.0: _ / _ | expectation: 0.0 rate > 12/100, aka scores worsen.
        """
        excl_rnd_set = [
            '002_ABC', '002_DEF', '004_GHK', '007_DEF', '010_KL',
            '012_AB', '014_CD', '016_DEF', '016_GH', '016_KL', '017_DEF',
            '019_ABC', '020_AB', '026_DEF', '028_EF', '030_GH', '032_AB',
            '032_EF', '033_KL', '034_EF', '036_AB', '038_DE',
            '041_ABC', '045_DEF', '054_GH', '062_ABC', '066_GH',
            '068_ABC', '068_DEF', '072_ABC', '074_ABC', '077_DEF',
            '078_CD', '080_ABC', '082_ABC', '083_DEF', '097_ABC',
            '102_AB', '108_CD', '109_ABC', '110_DEF', '111_EF', '115_DEF',
            '118_ABC', '118_DEF', '119_L', '120_GH', '129_DEF',
            '132_DEF', '135_ABC', '136_FG', '140_DEF', '141_EF', '144_CD',
            '144_EF', '145_LMN', '148_ABC', '148_DEF', '150_DEF', '152_DEF',
            '155_DEF', '158_CD', '160_A', '160_C', '169_DEF', '172_ABC',
            '172_KL', '173_FGH', '176_GHK', '177_DEF', '181_AB', '181_G', '183_DEF',
            '185_ABC', '189_EF', '198_EF', '208_DEF', '212_ABC',
            '123_EF', '151_CD', '171_M', '197_ABC', '201_KL', '124_AB', '104_AB',
            '025_AB', '027_FG', '031_ABC', '049_DEF', '051_GH', '055_ABC',
            '074_DEF', '080_G', '107_ABC', '107_L', '117_KL', '143_F', '146_DEF',
            '163_ABC', '193_ABCD', '203_ABC', '208_ABC',
            '210_L', '213_LMN', '164_DEF',
        ]# + [ # next comment this so that these weak are never excluded. see if performance appears to gets worse
        #    '091_AB', '039_DEF', '125_DEF', '042_DE', '071_FGH',
        #    '167_CD', '200_AB', '162_DEF', '168_DEF', '001_ABC', '205_DEF'
        #]
        excl_const += excl_rnd_set
        #print(excl_const);raise SystemExit
        """
        """

        #incl_always = ['144_EF', '210_L', '201_KL', '010_KL', '148_DEF', '031_ABC', '012_AB', '208_DEF', '110_DEF', '144_CD']
        #excl_rnd_set = [el for el in excl_rnd_set if not el in incl_always]
        #assert [not el in excl_rnd_set for el in incl_always]
        ...
        for _ in range(5):
            ...
            fpath_selectionScores = Path('ss_fold_specified_not.csv')
            row = pd.DataFrame({
                'rid':[rid],
